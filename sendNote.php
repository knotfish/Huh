...
curl_setopt( $ch, CURLOPT_URL, 'https://nurseapp3.firebaseio.com/users.json');
...
foreach ($userList as $user	){
	...
	function sendPushNotification($to = '', $data = array()){
		...
		$apiKey = 'AAAA4sqswsA:APA91bE2uhY9eIfqTH8hg2k4cdFzzwncwGAZte8s2RidG6p5A2guwAptv1WfmLvRr-8JbHgMiWadMlpOJUGY7sCIADFm6jtWjSI4gcKCzBpX170n7NR512r0OufTkLFtBRHQ72wGOYgF'; 
